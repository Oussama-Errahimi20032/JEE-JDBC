...
import static ma.ui.ClientForm.de;
import static ma.ui.ClientForm.nm;
import static ma.ui.ClientForm.num;
import static ma.ui.ClientForm.pm;
...
public class ServiceForm extends javax.swing.JInternalFrame {
    ...
    private void deleteServiceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteServiceActionPerformed
        // TODO add your handling code here:
        int reponse = JOptionPane.showConfirmDialog(this, "Voulez vous vraiment supprimé ce service ?");
        if(reponse == 0){
            if (ss.delete(ss.findById(id))) {
                JOptionPane.showMessageDialog(this, "le service à été bien supprimé");
            } else {
                JOptionPane.showMessageDialog(this, "La suppression de ce service est interdite car il compte déjà des clients");
            }
            load();
        }
    ...
    private void updateServiceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateServiceActionPerformed
        // TODO add your handling code here:
         id = Integer.parseInt(model.getValueAt(serviceTable.getSelectedRow(), 0).toString());
        int reponse = JOptionPane.showConfirmDialog(this, "Voulez vous vraiment modifié ce service ?");
        f = txtNom.getText();
        if(reponse == 0){
             if (ss.update(ss.findById(id))) {
